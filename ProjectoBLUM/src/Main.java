...
import modelo.*;
import modeloVideojuego.*;
import modeloConsola.*;
import vista.*;
...
public class Main {
    public static void main(String[] args) throws SQLException {
            try{
                ...
                DesarrolladoraDAO desarrolladoraDAO=new DesarrolladoraDAO(conexion);
                DesarrollaVista desarrollaVista=new DesarrollaVista();
                DesarrolladoraControlador desarrolladoraControlador=new DesarrolladoraControlador(desarrolladoraDAO,desarrollaVista);
                    ...
                    switch(opcion) {
                            ...
                            do {
                                ...
                                switch (opcion1) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        usuarioControladorCliente.editarCliente();
                                        break;
                                    case 0:
                            ...
                            do {
                                ...
                                switch (opcion2) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        usuarioControladorEmpleado.editarEmpleado();
                                        break;
                                    case 0:
                                        System.out.println("Saliendo de gestión de Clientes...");
                                        break;
                        ...
                        case 3:
                            do {
                                ...
                                System.out.println("4.Editar Videojuegos");
                                System.out.println("0.Atras");
                                System.out.print("Selecciona una opción: ");
                                ...
                                switch (opcion3) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        videojuegoControlador.editarVideojuego();
                                        break;
                                    case 0:
                        ...
                        case 4:
                            do {
                                System.out.println("\n===Gestion de consolas===");
                                System.out.println("1.Mostrar Inventario");
                                System.out.println("2.Agregar Consola");
                                System.out.println("3.Eliminar Cosola");
                                System.out.println("4.Editar Consola");
                                System.out.println("0.Atras");
                                System.out.print("Selecciona una opción: ");
                                ...
                                switch (opcion4) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        consolaControlador.editarConsola();
                                        break;
                                    case 0:
                        ...
                        case 5:
                            do {
                                ...
                                System.out.println("3.Eliminar Accesorio");
                                ...
                                switch (opcion5) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 4:
                                        accesorioControlador.editarAccesorio();
                                        break;
                                    case 0:
                        ...
                        case 6:
                            do {
                                ...
                                System.out.println("2.Agregar Desarrolladora");
                                System.out.println("3.Eliminar Desarrolladora");
                                System.out.println("3.Ediatr Desarrolladora");
                                System.out.println("0.Atras");
                                System.out.print("Selecciona una opción: ");
                                opcion6 = scanner.nextInt();
                                switch (opcion6) {
                                    case 1:
                                        desarrolladoraControlador.listaDesarrolladora();
                                        break;
                                    case 2:
                                        desarrolladoraControlador.agregarDesarrolladora();
                                        break;
                                    case 3:
                                        desarrolladoraControlador.eliminarDesarroladora();
                                        break;
                                    case 4:
                                        desarrolladoraControlador.editarDesarrolladora();
                                        break;
                                    case 0:
